...
?>
  <input name="sogd_post_festival_configuration_nonce" type="hidden" value="<?php echo wp_create_nonce(basename(__FILE__)); ?>">
  ...
  <input name="sogd_festival[external-link]" value="<?php echo is_array($sogd_festival_fields) ? $sogd_festival_fields['external-link'] : '' ?>">

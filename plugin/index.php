...
add_action('admin_menu', function () {
  remove_meta_box('postcustom', 'event', 'normal'); //removes custom fields for events
  remove_meta_box('tagsdiv-event-tag', 'event', 'normal'); //removes tags for events

  remove_submenu_page('edit.php?post_type=event', 'edit-tags.php?taxonomy=event-tag&amp;post_type=event'); //removes event tags
  remove_submenu_page('edit.php', 'edit-tags.php?taxonomy=post_tag'); //removes post tags
